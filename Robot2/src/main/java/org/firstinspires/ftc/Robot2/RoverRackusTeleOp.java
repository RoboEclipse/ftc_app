...
public abstract class RoverRackusTeleOp extends OpMode {
    ...
    public void loop() throws NullPointerException {
        ...
        try {
            ...
            Log.d("NullPointer", "NullPointerException Thrown!!!");
        }
        try {
            double lx = gamepad1.left_stick_x;
            double ly = -gamepad1.left_stick_y;
        ...
        catch(SecurityException stupid) {
            Log.d("Security", "SecurityException Thrown!!!");
        }
        try{
            double lx = gamepad1.left_stick_x;
            double ly = -gamepad1.left_stick_y;
            ...
            Log.d("Runtime", "RuntimeException Thrown!!!");
        }
    }
